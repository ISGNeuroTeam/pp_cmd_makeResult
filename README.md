# pp_cmd_makeResult
Postprocessing command "makeResult"
## Description
makeResult do (write here what it does)  
...
```
... | makeResult positional_arg, kwarg_int_argument=4  ...
```
...
### Run makeResult
Use `pp` to run makeResult command:  
```bash
pp
Storage directory is /tmp/pp_cmd_test/storage
Commmands directory is /tmp/pp_cmd_test/pp_cmd
query: | otl_v1 <# makeresults count=100 #> |  makeResult 
```
## Deploy
1. Unpack archive `pp_cmd_makeResult` to postprocessing commands directory
